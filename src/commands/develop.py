...
6. Create PR in Azure DevOps for review using MCP
7. Update work item #{work_item_id} state to 'Resolved' (try 'Committed' or 'In Review' if 'Resolved' is not valid)
   - Do NOT change assigned user, iteration, or other fields
