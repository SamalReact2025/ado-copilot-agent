...
- `-m, --model` — LLM model (default: `claude-sonnet-4.6`)
...
**Options:**
- `-m, --model` — LLM model (default: `claude-sonnet-4.6`)
- `-b, --base-branch` — Base branch to branch from (default: `qa`)
...
│   └── complete.py     # complete command (plan + develop + review)
├── services/
